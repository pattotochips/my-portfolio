          ...
          <Stack spacing={3} alignItems="center">
            <Grid container spacing={3}>
              <Grid size={{ xs: 12, md: 6 }}>
                <MediaSlot
                  file="ooo-generator-app.png"
                  caption="Pixel-art generator with live message preview"
                  gradient={accent}
                  maxWidth="100%"
                />
              </Grid>
              <Grid size={{ xs: 12, md: 6 }}>
                <MediaSlot
                  file="ooo-generator-tones.gif"
                  caption="Switching tone and watching the message restructure"
                  gradient={accent}
                  maxWidth="100%"
                />
              </Grid>
